...
import { TAuth } from '../services/interfaces/marker.interface';
...
export class AuthModalComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private modalService: CustomModalService, private modal: NzModalRef, private authService: AuthService) { }
